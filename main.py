...
Label(sroot,text="Management System",font='Timesnewroman 40 ',bg='white',fg='Black').place(x=535,y=10)
Label(sroot,text="Made by -",font='Timesnewroman 40 ',bg='white',fg='black').place(x=535,y=90)
Label(sroot,text="Aayush Kumar",font='Timesnewroman 40 ',bg='white',fg='black').place(x=535,y=180)
Label(sroot,text="kumar.aayush04@gmail.com",font='Timesnewroman 40',bg='white',fg='grey').place(x=535,y=270)
def mainroot():
	#sroot.destroy()
	root = Tk()
	...
	tf_label = Label(top_frame,text='Hotel Management System',font='msserif 33',fg='gray89',bg='black',height=70)
	...
	#-----------------------------------------------------------------
		nl = Label(b_frame,text='Made by Fenrir',fg='black',bg='gray91',font='msserif 8')
	...
	def staff():
		...
		Label(emp1inf,text="Mr. Aayush Kumar",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		Label(emp1inf,text="Extention : 025",bg='white',fg="Grey",font='msserif 10').place(x=60,y=59)
		Label(emp1inf,text="Mail : kumar@hotelname.com",bg='white',fg="Grey",font='msserif 10').place(x=60,y=83)
		emp1inf.pack_propagate(False)
		emp1inf.place(x=117,y=1)

		emp1f = Frame(b_frame)
		path2 = "images/goru.jpg"
		image=Image.open(path2)
		image = image.resize((117, 109), Image.ANTIALIAS)
		...
		Label(emp1inf,text="Mr. Gourav Ghosal",bg='white',fg="Grey",font='msserif 10').place(x=45,y=37)
		Label(emp1inf,text="Extention : 032",bg='white',fg="Grey",font='msserif 10').place(x=45,y=59)
		Label(emp1inf,text="Mail : gg69@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=45,y=83)	
		emp1inf.pack_propagate(False)
		...
		Label(emp1inf,text="Mr. Rajorshi ghosh",bg='white',fg="Grey",font='msserif 10').place(x=72,y=37)
		Label(emp1inf,text="Extention : 028",bg='white',fg="Grey",font='msserif 10').place(x=72,y=59)
		Label(emp1inf,text="Mail : rajorshighosh@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=72,y=83)	
		emp1inf.pack_propagate(False)
		...
		Label(emp1inf,text="Mr. Manish Nath",bg='white',fg="Grey",font='msserif 10').place(x=55,y=37)
		Label(emp1inf,text="Extention : 041",bg='white',fg="Grey",font='msserif 10').place(x=55,y=59)
		Label(emp1inf,text="Mail : manishnath@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=55,y=83)	
		emp1inf.pack_propagate(False)
		...
		b_frame.pack_propagate(False)
		b_frame.tkraise()
		nl = Label(b_frame,text='Made by Aayush',fg='black',bg='gray91',font='msserif 8')
		nl.place(x=955,y=310)
		nl.tkraise()
